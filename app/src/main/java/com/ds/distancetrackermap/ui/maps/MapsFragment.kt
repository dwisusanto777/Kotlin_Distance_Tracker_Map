...
import com.ds.distancetrackermap.databinding.FragmentMapsBinding
import com.ds.distancetrackermap.model.Result
import com.ds.distancetrackermap.service.TrackerService
import com.ds.distancetrackermap.util.Constant
import com.ds.distancetrackermap.util.ExtensionFunctions.disable
import com.ds.distancetrackermap.util.ExtensionFunctions.enable
import com.ds.distancetrackermap.util.ExtensionFunctions.hide
import com.ds.distancetrackermap.util.ExtensionFunctions.show
...
//                Log.d("LocationList", locationList.toString())
    ...
    private fun stopForegroundDown() {
        binding.startButton.disable()
    ...
    private fun displayResult(){
        var result = Result(
            ...
            MapUtil.calculatedElapsedTime(startTime, stopTime)
        )
    ...
    private fun mapReset() {
        fusedLocationProviderClient.lastLocation.addOnCompleteListener {
            ...
            map.animateCamera(
                CameraUpdateFactory.newCameraPosition(
                    MapUtil.setCameraPosition(lastKnowLocation)
                )
            )
